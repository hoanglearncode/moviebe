...
export const ErrEmailAlreadyExists = new ConflictError(
  "Email already exists",
  ErrorCode.EMAIL_EXISTS,
);
export const ErrUsernameAlreadyExists = new ConflictError(
  "Username already exists",
  ErrorCode.USERNAME_EXISTS,
);
export const ErrUserInactive = new UnauthorizedError(
  "User account is not active",
  ErrorCode.ACCOUNT_INACTIVE,
);
export const ErrEmailNotVerified = new UnauthorizedError(
...
export const ErrNewPasswordSameAsCurrent = new ValidationError(
  "New password must be different from current password",
);
export const ErrPasswordUnchangeable = new UnauthorizedError(
  "Password login is not available for this account",
);

// Session errors
export const ErrSessionNotFound = new NotFoundError("Session");
export const ErrSessionExpired = new UnauthorizedError(
  "Session has expired",
...
// Account errors
export const ErrAccountDeletionFailed = new ValidationError(
  "Failed to delete user account",
  {},
  ErrorCode.INTERNAL,
);
export const ErrAccountPasswordChangeFailed = new ValidationError(
  "Failed to update password",
  {},
  ErrorCode.INTERNAL,
);
export const ErrAccountUpdateFailed = new ValidationError(
  "Failed to update user account",
  {},
  ErrorCode.INTERNAL,
);
export const ErrAccountCreationFailed = new ValidationError(
...
// Admin errors
export const ErrAdminOnlyAction = new UnauthorizedError(
