import { IWalletRepository, ITransactionRepository, IWithdrawalRepository } from "../interface/finance.interface";
...
export class PartnerDashboardUseCase implements IPartnerDashboardUseCase {
  ...
  async getDashboardStats(partnerId: string): Promise<any> {
    ...
    const stats: DashboardStats = {
      ...
      occupancyRate: 0,
      avgSalesPerShowtime:
        activeShowtimes.total > 0 ? revenue.count / activeShowtimes.total : 0,
