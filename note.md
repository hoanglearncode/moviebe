todo: 
- bổ sung các sự kiện mới của hệ thống socket xoay quanh duyệt partner và cập nhật badge (socket + thủ công) hiện tại đang có badges liên quan đến partner mới cần duyệt 
- chưa có noti gửi đến admin qua tất cả các kênh khi có user đăng kí làm partner mới
- gửi phản hồi ở fe chưa hoạt động 
- đồng nhất ngôn ngữ về tiếng việt có dấu phần màn hình quản lý partner 
