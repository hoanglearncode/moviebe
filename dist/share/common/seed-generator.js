...
const FIRST_NAMES = [
    "Nguyễn", "Trần", "Võ", "Phạm", "Hoàng", "Dương", "Bùi", "Đỗ", "Cao", "Đặng",
    "Ngo", "Vũ", "Tạ", "Tô", "Từ", "Hồ", "Lương", "Lâm", "Tây", "Ưu",
    "Anh", "Bình", "Cường", "Dũng", "Eminence", "Phúc", "Giang", "Hải", "Hạnh", "Hào",
    "Hùng", "Huy", "Hương", "Huỳnh", "Huyền", "Ích", "Ích", "Ích Lâm", "James", "John",
    "Alex", "Michael", "David", "Robert", "Richard", "Christopher", "Mark", "Daniel", "Steven", "Paul",
];
const LAST_NAMES = [
    "Văn", "Thọ", "Chính", "Triều", "Tấn", "Tuấn", "Tường", "Tuyên", "Tùng", "Tuệ",
    "Tú", "Toàn", "Toán", "Thiện", "Thiệu", "Thịnh", "Thới", "Thông", "Thạch", "Thái",
    "Tâm", "Tân", "Tạng", "Tạo", "Tâu", "Tâu", "Thắng", "Thăng", "Thắm", "Thân",
    "Thành", "Thích", "Thịnh", "Thống", "Thốn", "Thương", "Thương", "Tích", "Tiến", "Tips",
    "Smith", "Johnson", "Williams", "Brown", "Jones", "Garcia", "Miller", "Davis", "Rodriguez", "Martinez",
];
const LOCATIONS = [
    "Hà Nội", "TP. Hồ Chí Minh", "Đà Nẵng", "Hải Phòng", "Cần Thơ",
    "Biên Hòa", "Hải Dương", "Hà Tĩnh", "Thanh Hóa", "Nghệ An",
    "Quảng Ninh", "Bắc Giang", "Bắc Ninh", "Hưng Yên", "Hà Nam",
    "Nam Định", "Ninh Bình", "Thanh Hóa", "Hà Tĩnh", "Quảng Bình",
    "Quảng Trị", "Thừa Thiên Huế", "Quảng Nam", "Quảng Ngãi", "Bình Định",
    "Phú Yên", "Khánh Hòa", "Ninh Thuận", "Bình Thuận", "Đồng Nai",
    "Bà Rịa - Vũng Tàu", "Long An", "Tiền Giang", "Bến Tre", "Trà Vinh",
    "Sóc Trăng", "Bạc Liêu", "Cà Mau", "An Giang", "Kiên Giang",
];
const BIO_TEMPLATES = [
